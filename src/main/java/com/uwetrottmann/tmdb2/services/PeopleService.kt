...
interface PeopleService {
    ...
    fun taggedImages(
            @Path("id") tmdbId: Int, @Query("page") page: Int?, @Query("language") language: String
    ): Observable<TaggedImagesResultsPage>
